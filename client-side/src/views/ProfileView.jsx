  ...
  _renderOptions = () => {
      return(
        <div class="container" style={{ marginTop: "3em" }}>
            <div class="row card p-card" style={{minHeight:'30em'}}>
                <div class="col-lg-12 text-center">
                    <h1>Please select one of the following:</h1>
                </div>
                <div class="col-lg-12 d-inline text-center" style={{marginTop:'10em'}}>
    ...
    return (
      <div className="container">
        <div className="row" style={{ marginTop: "5em" }}>
          {this.props.user ? this._renderProfile() : this._renderOptions()}
        </div>
      </div>
    );
  }
